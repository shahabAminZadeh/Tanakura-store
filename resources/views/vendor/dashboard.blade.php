    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                @if($status === 'active')
                    <h4>  پنل فروشنده <span class="text-success"> فعال  </span> است </h4>
                @else
                    <h4> پنل فروشنده <span class="text-danger"> غیر فعال </span> است </h4>
                    <p>لطفا به مدیران درخوایت فعال شدن پنل را بدهید</p>
