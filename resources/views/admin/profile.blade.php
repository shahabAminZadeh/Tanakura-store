                    ...
                    <div class="col-md-6"><div class="card card-primary card-outline">
                            <div class="card-body box-profile">
                                <div class="text-center">
                                    <img class="profile-user-img img-fluid img-circle" src="{{(!empty($data->photo)) ? url('upload/admin/image/'.$data->photo): url('upload/admin/image/no_images.png')}}" alt="User profile picture">
                                </div>
                                <br>
                            ...
                            <div class="card card-primary">
                                <form method="post" action="{{route('AdminProfileStore')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="text-center">
                                            <img id="ShowImageAdmin" class="profile-user-img img-fluid img-circle" src="{{(!empty($data->photo)) ? url('upload/admin/image/'.$data->photo): url('upload/admin/image/no_images.png')}}" alt="User profile picture">
                                        </div>
                                    </div>
