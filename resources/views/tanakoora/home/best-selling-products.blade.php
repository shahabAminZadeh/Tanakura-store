        ...
        <div class="row justify-content-center">
                ...
                <div class="single-products style-box">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img src="{{asset('tanakoora/assets/images/products/product-39.jpg')}}" alt="Image">
                        </a>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-products style-box">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img src="{{asset('tanakoora/assets/images/products/product-38.jpg')}}" alt="Image">
                        </a>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-products style-box">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img src="{{asset('tanakoora/assets/images/products/product-16.jpg')}}" alt="Image">
                        </a>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-products style-box">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img src="{{asset('tanakoora/assets/images/products/product-37.jpg')}}" alt="Image">
                        </a>
